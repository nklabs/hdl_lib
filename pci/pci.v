...
#(
  ...
  inout [31:0] ad,
  input [3:0] be_l,
  input irdy_l,		// No input FF on this signal! Needs 7ns setup time.
  input frame_l,
  input idsel,
  output trdy_l,
  output stop_l,
  ...
  output reg bus_rd_wr_l,
  output reg bus_req,
  output wire [ADDRWIDTH-1:0] bus_addr,
...
wire bus_ackt = bus_ack || timeout;		// Acknowledgment
