...
module maxii_flash
  ...
  input reread,
  output reg bank_select, // Bank select bit output

  input [7:0] bus_in, // 8-bits in
  output reg [15:0] data_out, // Data output

  input load_addr, // Load 8-bits into address register (upper first)
  input load_data, // Load 8-bits into data register (upper first)
  input read_req, // Read from flash
  input write_req, // Write to flash
  input erase_req, // Erase sector
  output wire busy // High if busy erasing or programming
  );
